                ...
                builder: (context, snapshot) {
                  if (!snapshot.hasData) {
                    ...
                    return Scaffold(
                      ...
                      appBar: AppBar(
                        title: Text("ร้านค้า"),
                        actions: <Widget>[CartIcon()], // actions: <Widget>[Search(shops.shops), CartIcon()],
                      ),
                    );
                  }
                })
            : Scaffold(
                ...
                body: ListView(children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "เนื่องจากที่อยู่ยังไม่ถูกตั้งค่ากรุณาตั้งค่าที่อยู่",
                      style: TextStyle(
                          fontSize: 20,
...
class Shopssearch extends SearchDelegate<Shop> {
  ...
  @override
  String get searchFieldLabel => "ค้นหาร้านค้า";
